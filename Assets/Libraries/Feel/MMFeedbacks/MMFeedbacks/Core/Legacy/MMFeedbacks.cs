...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbacks : MonoBehaviour
	{
		...
		public virtual void PlayFeedbacksWithCallback(Action onCompleteCallback)
		{
			PlayFeedbacksInternalWithCallback(this.transform.position, FeedbacksIntensity, onCompleteCallback);
		}
		/// <summary>
		...
		protected virtual void PlayFeedbacksInternalWithCallback(Vector3 position, float feedbacksIntensity, Action callback = null, bool forceRevert = false)
		{
			if (!CanPlay)
			{
				return;
