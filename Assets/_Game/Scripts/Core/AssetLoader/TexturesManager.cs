...
public class TexturesManager : TPRLSingleton<TexturesManager>
{
    [SerializeField]
    ...
    public Sprite GetSprites(string sprite_name)
    {
        ...
        {
            Sprite sprite = Resources.Load<Sprite>($"{BundleName.Textures}/{sprite_name}");
    ...
    public Sprite GetComicSprites(string sprite_name)
    {
        ...
        {
            Sprite sprite = Resources.Load<Sprite>($"{BundleName.SPRITE}/{sprite_name}");
    ...
    public Texture2D GetTexutres(string texture_name)
    {
        ...
        {
            Sprite sprite = Resources.Load<Sprite>($"{BundleName.Textures}/{texture_name}");
