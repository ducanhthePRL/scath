...
public class MenuEditor : MonoBehaviour
{
    ...
    {
        EditorSceneManager.OpenScene("Assets/_Game/Scenes/Splash.unity");
    ...
    {
        EditorSceneManager.OpenScene("Assets/_Game/Scenes/GamePlayCanvas.unity");
    }

    [MenuItem("Hai/GamePlayMain")]
    private static void GamePlayMain()
    {
        EditorSceneManager.OpenScene("Assets/_Game/Scenes/GamePlayMain.unity");
    }
